...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { data_type_id: @field.data_type_id, description: @field.description, name: @field.name, table_id: @field.table_id }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { data_type_id: @field.data_type_id, description: @field.description, name: @field.name, table_id: @field.table_id }
    assert_redirected_to field_path(assigns(:field))
  end
